...
let colors_name = 'tti_solarized_flat_light'
...
hi LineNr                                  cterm=NONE  ctermfg=133  ctermbg=53  guifg=#93a1a1  guibg=#eee8d5  gui=NONE
...
hi TabLine                                 cterm=NONE  ctermfg=133  ctermbg=53  gui=underline  guifg=#657b83  guibg=#eee8d5  guisp=#657b83
hi TabLineFill                             cterm=NONE  ctermfg=53  ctermbg=53  gui=underline  guifg=#657b83  guibg=#eee8d5  guisp=#657b83
hi TabLineSel                              cterm=NONE  ctermfg=255  ctermbg=53  gui=underline,reverse  guifg=#93a1a1  guibg=#073642  guisp=#657b83
